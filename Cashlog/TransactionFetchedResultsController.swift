...
class TransactionFetchedResultsController: NSFetchedResultsController<Transaction>, NSFetchedResultsControllerDelegate {
    ...
    init(moc: NSManagedObjectContext, tableViewController: UITableViewController) {
        ...
        super.init(fetchRequest: Transaction.fetchRequest(), managedObjectContext: moc, sectionNameKeyPath: nil, cacheName: nil)
